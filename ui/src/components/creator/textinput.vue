<template>
  <div class="w-full bg-black rounded-lg p-2">
    ...
    <div class="flex w-full h-20 p-2 rounded-lg justify-center items-center">
      <input class="h-3/4 w-full rounded-lg text-center focus:outline-none bg-gray-800 text-white focus:outline-white focus:outline-1" type="text" @input="EmitInput">
    </div>
  </div>
</template>
